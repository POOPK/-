...
class Get_main():
    ...
    def getData(self,room_num,file_path):
        wb = webdriver.Chrome(r'E:\chromedriver.exe')
        ...
        wb.find_element_by_xpath('//input[@id="login_name"]').send_keys(21801190087)
        wb.find_element_by_xpath('//input[@id="password"]').send_keys(13507541828)
